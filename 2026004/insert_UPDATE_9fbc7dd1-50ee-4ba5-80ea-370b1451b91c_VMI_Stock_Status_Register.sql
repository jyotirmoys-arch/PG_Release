-- =====================================================
-- INSERT statement for content_id: 9fbc7dd1-50ee-4ba5-80ea-370b1451b91c
-- Name: #VMI Stock Status Register#
-- Action: UPDATE
-- Version: 2026004
...
VALUES (
    '9fbc7dd1-50ee-4ba5-80ea-370b1451b91c', 0, 0,
    NULL, '#VMI Stock Status Register#', 'This report will display item wise stock details (as of now) for each vendor selected by user. ',
    '<report>
  <main>
    <id>9fbc7dd1-50ee-4ba5-80ea-370b1451b91c</id>
    <report_name>#VMI Stock Status Register#</report_name>
    ...
    <description>This report will display item wise stock details (as of now) for each vendor selected by user. </description>
    <filter_description />
  ...
  <entity>
    <entity_name>LV_REALTIMESTOCK_STKPOINT_01</entity_name>
    <group_by_flag>False</group_by_flag>
  ...
  <cell>
    <id>1497790513</id>
    <cell_text>=Bold(''As On: '')&amp;GlobalDateFormat(Now())</cell_text>
    <cell_type>formula</cell_type>
    <cell_row>2</cell_row>
    <cell_col>0</cell_col>
    <cell_horizontal_align>Center</cell_horizontal_align>
  ...
  <cell>
    <id>2047646447</id>
    <cell_text>=''Stock Qty. ''&amp;''As On &lt;''&amp; GlobalDateFormat(now())&amp;''&gt;''</cell_text>
    <cell_type>formula</cell_type>
    <cell_row>4</cell_row>
  ...
  <cell>
    <id>469448457</id>
    <cell_text>LV_REALTIMESTOCK_STKPOINT_01.stockpointname</cell_text>
  ...
  <cell>
    <id>1330118873</id>
    <cell_text>  =AggSum({Real time Stock Point wise Stock.closingstockqty})</cell_text>
    <cell_type>text</cell_type>
    <cell_row>7</cell_row>
    <cell_col>13</cell_col>
    <cell_horizontal_align>Right</cell_horizontal_align>
  ...
  <cell>
    <id>915460499</id>
    <cell_text>=AggSum({LV_REALTIMESTOCK_STKPOINT_01.closingstockqty})</cell_text>
    <cell_type>formula</cell_type>
    <cell_row>8</cell_row>
    <cell_col>13</cell_col>
    <cell_horizontal_align>Right</cell_horizontal_align>
  ...
  <row>
    ...
    <group_field>LV_VENDOR_ITEM_01.name</group_field>
  </row>
  <row>
  ...
  <column>
    <column_width>137</column_width>
  </column>
  <column>
    <column_width>112</column_width>
  </column>
  <column>
    <column_width>101</column_width>
  </column>
  ...
  <join>
    ...
    <entity_to_name>LV_REALTIMESTOCK_STKPOINT_01</entity_to_name>
    <entity_from_id>LV_ITEM_01</entity_from_id>
    <entity_to_id>LV_REALTIMESTOCK_STKPOINT_01</entity_to_id>
  ...
  <sort>
    <sort_name>LV_VENDOR_ITEM_01.name</sort_name>
    <sort_title />
  ...
  <sort>
    <sort_name>LV_REALTIMESTOCK_STKPOINT_01.stockpointname</sort_name>
    <sort_title />
    <order_num>2</order_num>
    <ascending_flag>True</ascending_flag>
  </sort>
  <sort>
    <sort_name>LV_ITEM_01.category1</sort_name>
    <sort_title />
    <order_num>3</order_num>
    <ascending_flag>True</ascending_flag>
  </sort>
  <sort>
    <sort_name>LV_ITEM_01.category2</sort_name>
    <sort_title />
    <order_num>4</order_num>
    <ascending_flag>True</ascending_flag>
  </sort>
  <sort>
    <sort_name>LV_ITEM_01.category3</sort_name>
    <sort_title />
    <order_num>5</order_num>
    <ascending_flag>True</ascending_flag>
  </sort>
  <sort>
    <sort_name>LV_ITEM_01.category4</sort_name>
    <sort_title />
    <order_num>6</order_num>
    <ascending_flag>True</ascending_flag>
  </sort>
  <sort>
    <sort_name>LV_ITEM_01.category5</sort_name>
    <sort_title />
    <order_num>7</order_num>
    <ascending_flag>True</ascending_flag>
  </sort>
  <sort>
    <sort_name>LV_ITEM_01.category6</sort_name>
    <sort_title />
  ...
  <filter>
    ...
    <filter_ref_id>253131692</filter_ref_id>
  ...
  <dynamicfilters />
    ...
    '2020-04-14 17:22:41', '1142', '2026-06-16 08:29:18.855954',
...
VALUES (
    '9fbc7dd1-50ee-4ba5-80ea-370b1451b91c', '56e983e1-ba23-4c38-b8ce-ec8b83d234a5', 2,
